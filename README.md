...
*   [airp2018/Open-AutoGLM-SIGI](https://github.com/airp2018/Open-AutoGLM-SIGI) - \[SIGI-System] 原生安卓版 AutoGLM 智能体。📦 部署: 标准 Android APK 一键安装 (无需电脑/Root)。🏗 核心: 基于 Chaquopy 引擎，将 Python Agent 直接嵌入安卓原生进程。⚡️ 特性: 赛博朋克叙事 UI | 零延迟响应。 (Native AutoGLM Client | One-Click Install | Powered by Chaquopy)
...
*   [666fy666/WebMoniter](https://github.com/666fy666/WebMoniter) - 一款整合社交媒体动态/直播开播、下播提醒检测与推送的服务， 目前支持：微博、虎牙。
...
*   [jhihhe/House-Survey-Workflow-Assistant](https://github.com/jhihhe/House-Survey-Workflow-Assistant) - 📁 专为房产摄影工作流打造的桌面自动化工具。支持批量创建标准化目录、多线程极速导卡、实时收入统计。采用 Dracula 主题，Python 原生开发，macOS/Windows 开箱即用

*   [mini-yifan/baodou\_AI](https://github.com/mini-yifan/baodou_AI) - 包豆电脑是一款基于 豆包AI 视觉模型的智能控制系统，能够通过分析屏幕内容自动执行鼠标和键盘操作，实现任务自动化。

*   [aexachao/nas-subtitle-manager](https://github.com/aexachao/nas-subtitle-manager) - 🎬 基于 Whisper + LLM 的 NAS 视频字幕自动提取与翻译工具，支持 Docker 一键部署
...
*   [qianye60/XianTu](https://github.com/qianye60/XianTu) - 《仙途》AI驱动的沉浸式修仙文字冒险游戏，基于 Vue 3 + TypeScript +Fastapi，支持 Gemini/Claude/OpenAI 等多种 AI 模型
...
*   [junxiaopang/all-image-prompts](https://github.com/junxiaopang/all-image-prompts) - 汇集了来自 Midjourney、DALL-E 3、Flux、Grok、Gemini (NanoBanana) 以及 Seedream 等多个主流 AI 模型的优质提示词（Prompts）。
...
*   [sourcexu7/XPhotos](https://github.com/sourcexu7/XPhotos) -
...
*   [oiliness-w4v0/desktop-rss](https://github.com/oiliness-w4v0/desktop-rss) - 桌面软件 RSS 订阅
...
*   [cxbdasheng/dnet](https://github.com/cxbdasheng/dnet) - 一款轻量级动态网络管理工具，支持多平台的 CDN、DNS 和内网穿透自动化管理与监控。
...
*   [Luoevanescence/word-wonderland](https://github.com/Luoevanescence/word-wonderland) - 一个现代化的英语学习平台，包含单词管理、短语、句子、句型和主题学习功能。
...
*   [jianzhichu/dysync.net](https://github.com/jianzhichu/dysync.net) - 抖音视频同步工具
