...
*   [hungryM0/SurveyController](https://github.com/hungryM0/SurveyController) - 支持问卷星、腾讯问卷的高并发自动化程序，附带友好的图形化界面；可指定ip地区、作答时长、AI填空，1分钟猛干50份。稳定更新
...
*   [YoKONCy/PeroCore](https://github.com/YoKONCy/PeroCore) - 基于 Python+Rust+Three.js 构建的 AI 桌宠，内置高性能记忆引擎
...
*   [hcllmsx/hugo-jijian](https://github.com/hcllmsx/hugo-jijian) - 一个基于PaperMod二次开发的hugo主题，对中文用户做了很好的适配。
...
*   [RivenLau/orion-key](https://github.com/RivenLau/orion-key) - 🔑 Orion Key — 现代化开源自动发卡平台，极简优雅的界面设计，基于 React + Tailwind CSS + Next.js + Spring Boot + PostgreSQL   全新架构打造的发卡网，重新定义虚拟数字商品销售体验
...
*   [xintaofei/codeg](https://github.com/xintaofei/codeg) - A unified workspace for local AI coding agents (Claude Code, Codex, Gemini CLI, etc.) — desktop app, standalone server, or Docker. Session aggregation, git worktree workflows, MCP/Skills management, and integrated terminal, all accessible from any browser.（多 AI 编码代理统一工作台）
...
*   [CodingFeng101/CanvasAnvil](https://github.com/CodingFeng101/CanvasAnvil) - One prompt, three pipelines: Flow / CAD / PPT  Flow: Conversational flowchart generation with patch / replace  CAD: Interior design → analysis → 2D plans (SVG) → renderings → BOM  PPT: Structured slides from a topic, with incremental editing & NotebookLM PPT support
...
*   [kawayiYokami/P-ai](https://github.com/kawayiYokami/P-ai) - 可召唤、可委派、可执行的桌面 AI 工作中枢 / A summonable desktop AI command center that can plan,     delegate, and execute
...
*   [Tght1211/lan-proxy-gateway](https://github.com/Tght1211/lan-proxy-gateway) - 把你的 Mac 变成局域网透明代理网关，让 Switch、智能电视等设备科学上网
