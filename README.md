...
* [shepherdleong-art/creative-studio](https://github.com/shepherdleong-art/creative-studio) - AI图片视频素材生成工作台

* [pimyf/talk-video-edit-kit](https://github.com/pimyf/talk-video-edit-kit) - 口播视频剪辑 Codex Skill 合集 + Remotion 渲染模板

* [seme-org/open-director](https://github.com/seme-org/open-director) - 🎬 开源 AI 视频工作室 — 从一句话到成片。支持创意模式（AI 导演全流程自动生成）和批量模式（批量生产短视频）。Open-source AI video studio — from one sentence to final video. Supports creative mode (AI director full workflow) and batch mode (bulk short video production)

* [Agions/frame-fab](https://github.com/Agions/frame-fab) - frame-fab - AI 漫剧创作平台。输入一本小说，AI 自动把它拍成一部漫剧。
...
* [vorojar/AgentClaw](https://github.com/vorojar/AgentClaw) - 24/7 AI 指挥官 + Agent 托管平台（Hive）。理解意图、规划任务、调度工具、记住一切。支持 Telegram/WhatsApp/钉钉/飞书/QQ/企业微信 多渠道。TypeScript monorepo，多 LLM 支持，Tauri 桌面应用。

* [cropflre/nowen-note](https://github.com/cropflre/nowen-note) - 开源自托管笔记与私有知识库，支持 Markdown/富文本、AI 写作、思维导图、任务管理、全文搜索、多级笔记本和 Docker 一键部署。

* [yoea/vibe\_blog\_next](https://github.com/yoea/vibe_blog_next) - 一个美观、自托管、Agent友好的开源博客，前端Next.js，后端基于Supabase，支持Markdown写作和MCP调用管理文章。

* [super-mortal/Links-Navigator](https://github.com/super-mortal/Links-Navigator) - Links-Navigator是一个自托管书签管理系统，用于保存、分类、搜索和整理网页链接

* [gong9/SenseFrame](https://github.com/gong9/SenseFrame) - 你的摄影助手

* [Junglepan/Painting-Box](https://github.com/Junglepan/Painting-Box) - 为摄影爱好者设计的照片水印工具
...
* [ad-naan/blog](https://github.com/ad-naan/blog) - A React+NodeJs Full Stack “Turn Of The page" AI Agent Blog
...
* [bingoYB/ham\_home](https://github.com/bingoYB/ham_home) - HamHome is an AI-powered browser extension for browser workspace for bookmarks & tabs: auto-categorization, summaries, semantic search, and secure WebDAV sync. | HamHome 是一款 AI 驱动的浏览器工作空间插件，用于智能管理浏览器书签与标签页工作区，支持智能分类、网页摘要、语义检索与 WebDAV 同步。
...
* [nuwax-ai/nuwax](https://github.com/nuwax-ai/nuwax) - Nuwax Agent OS - An enterprise-grade AI Agent Development and Operation Platform - Providing a complete solution for agent creation and distribution, knowledge base management, model proxy, memory system, and plugin ecosystem.
...
* [openmood/SyncToNotion](https://github.com/openmood/SyncToNotion) - 企微同步Notion - 支持抖音/小红书链接解析和Live图处理的Cloudflare Workers项目
...
* [Jimmylxue/h5pack-core](https://github.com/Jimmylxue/h5pack-core) - 不学 Java，不装 Android Studio，把你现有的 H5 项目直接打包成可上架的 Android 应用
...
* [mchaNetwork/github-proxy](https://github.com/mchaNetwork/github-proxy) - Yet another GitHub proxy running on Web Workers
...
* [JamesNZL/notion-assignment-import](https://github.com/JamesNZL/notion-assignment-import) - A free cross-browser extension to load Canvas assignments into Notion, with 19k+ unique users.
...
* [zhibaiYingChuan/LRC](https://github.com/zhibaiYingChuan/LRC) - 为 AI 记忆提供了一种从“容器”到“场”的范式迁移，实现永久记忆。

* [l0ng-ai/papr](https://github.com/l0ng-ai/papr) - A fast, native RSS reader for the desktop.
...
* [CloverCatLab/NanoTrans](https://github.com/CloverCatLab/NanoTrans) - 极致轻量化输入翻译助手  --Built with Rust
...
* [YUxiangLuo/miao](https://github.com/YUxiangLuo/miao) - 开箱即用的 sing-box 启动器，支持Linux桌面/OpenWrt软路由。30秒实现 TUN 模式透明代理。
...
* [caoling2010/openai-plugins-zh](https://github.com/caoling2010/openai-plugins-zh) - Codex 插件中文索引：中文说明、关键词搜索、官方分类浏览，并自动同步 OpenAI 插件列表。
...
* [Mark-kow/Photography-Community](https://github.com/Mark-kow/Photography-Community) - 一个功能完整的摄影作品分享社区平台，基于 React + Node.js + MySQL 构建/A fully functional photography sharing community platform, built with React + Node.js + MySQL.
...
* [bitshift-byte/Dify-WebUI](https://github.com/bitshift-byte/Dify-WebUI) - 由 Dify API 驱动的前沿桌面智能对话应用，具备企业级人工智能对话能力。这款应用拥有主题定制、知识库管理以及多场景应用等显著功能。​ 如今，我们进行了重大升级，新增对 OpenAI 格式输出的支持。这意味着，它能够与市面上所有遵循 OpenAI 格式的人工智能模型无缝对接。不管您使用的是知名供应商的模型，比如提供可靠且可扩展云端解决方案的 Azure OpenAI，还是以先进自然语言处理能力闻名的 Cohere，又或是专注于人工智能安全与伦理的 Anthropic 等众多供应商的模型，我们的应用都能满足需求。这种拓展后的兼容性，确保您可以在我们直观且功能丰富的桌面应用中，充分发挥您心仪的符合 OpenAI 标准的模型的强大效能。
...
* [TiiJeiJ8/Constella](https://github.com/TiiJeiJ8/Constella) - A self-hosted real-time collaborative infinite canvas for structured thinking and visual knowledge creation.自托管实时协作无限画布，赋能结构化思考与可视化知识创作。

* [ShenTuZ/photo-blog](https://github.com/ShenTuZ/photo-blog) - 一个简单的自我的摄影作品网站
...
* [xp-bear/noteWall\_pc\_f](https://github.com/xp-bear/noteWall_pc_f) - 留言墙功能可以让用户在网站上发表留言，以便其他用户可以看到并回复。它可以帮助网站的用户更好地交流，提高网站的互动性，增加用户体验。使用技术栈: vue3+express+mysql,觉得还可以的话,可以给一个star~
...
* [steen889/WuAiScreenOff](https://github.com/steen889/WuAiScreenOff) - 吾爱熄屏 · WuAi ScreenOff 一个极小的 Windows 熄屏关屏小工具(单文件、绿色、离线)。和系统"锁屏"不同——它只把屏幕熄掉、不锁电脑:后台的下载 / 渲染 / 远程 / 挂机任务一秒不停,唤醒后直接回到桌面,不需要重新输入开机密码。A tiny Windows screen-off utility (single file, portable, offline).
...
* [EasyTidy/EasyTidy](https://github.com/EasyTidy/EasyTidy) - EasyTidy A simple file auto-classification tool  makes it easy to create automatic workflows with files. / EasyTidy 一个简单的文件自动分类整理工具  轻松创建文件的自动工作流程
...
* [shiz81463/douyin-competitor-download](https://github.com/shiz81463/douyin-competitor-download) - 抖音对标视频下载工具 v2.0 — 三层视频发现引擎(f2+DuckDuckGo+Playwright)、跨平台(macOS/Windows)、流量元数据采集
...
* [xiyue188/RAG](https://github.com/xiyue188/RAG) - DeepBlue Brain：一个面向 RAG 全链路教学与理解的白盒化交互平台，支持各类文档上传、混合检索、实时检索日志流、提示词原文溯源与流式问答。
...
* [T0UGH/videoclaw](https://github.com/T0UGH/videoclaw) -   AI 视频创作 CLI 工具，深度集成 Seedance 2.0 + Chatgpt Imagen2 业界顶级模型，告诉 AI   你的想法，它会自动完成从素材生成到视频合成的全部工作，并支持自动发布到抖音、快手等平台。
...
* [Future-404/TAV-X](https://github.com/Future-404/TAV-X) - AI脚本合集 一键安装命令  bash <(curl -s -L https://tav-x.rka.qzz.io)      🧑🧑
...
* [zhaofu-hhh/synthetix](https://github.com/zhaofu-hhh/synthetix) - 致力于更优雅的AI生成短视频，并提供webui界面，方便创作
...
* [you-want/PinWall](https://github.com/you-want/PinWall) - 📌 PinWall 是一款直接铺在 macOS 桌面上的便签墙应用。透明窗口、自由拖拽、智能提醒——让每一条备忘都有存在感。

* [dangxiaoshi/bootcamp-podcast-map](https://github.com/dangxiaoshi/bootcamp-podcast-map) - AI视频播客剪辑营闯关地图与作业卡片页面

* [laoqi2333/486image-c](https://github.com/laoqi2333/486image-c) - 一款轻量化的摄影师返图选图筛图系统 —— 让客户在线选片
...
* [6haolou/GeoWelcome](https://github.com/6haolou/GeoWelcome) - 动态个性化欢迎页面，基于访客的地理位置和时间自动生成个性化的问候语。简单部署，一键发布，欢迎您的到来！
...
* [Sanqi-normal/tech-hexo](https://github.com/Sanqi-normal/tech-hexo) - 便捷地新增与切换风格的hexo博客主题
...
* [jkjoy/typecho-theme-timellow](https://github.com/jkjoy/typecho-theme-timellow) -  Typecho 极简主题
...
* [pengweizhong/yeah\_music](https://github.com/pengweizhong/yeah_music) - Yeah Music 🎶 是一个基于 Flutter 开发的跨平台音乐应用
...
* [naaammme/pilipro](https://github.com/naaammme/pilipro) - 使用Flutter开发的BiliBili第三方安卓客户端，对piliplus做了最小化修改，增加一些自用功能——自动记录评论和弹幕，应用内小窗。小字：pro是PeRsOnal的缩写，非professional（由于种种原因此项目已不再更新维护，转而维护新的客户端https://github.com/naaammme/bbspace）
...
* [DarkKandaoMaster/QuickSay](https://github.com/DarkKandaoMaster/QuickSay) - 一款强大的快捷短语软件（聊天/常用语/快捷回复/快捷语录/客服工具/文本暂存器/输入Prompt很好用）
...
* [Thoseyearsbrian/Aegis](https://github.com/Thoseyearsbrian/Aegis) - Personal Digital Firewall Ruleset for Surge on iOS & macOS
