...
*   [Beadd/Creamplayer](https://github.com/Beadd/Creamplayer) - A music downloader with metadata
...
*   [openorch/openorch](https://github.com/openorch/openorch) - Build smarter. Orchestrate faster. A unified platform for AI, microservices, and beyond.
...
*   [licyk/sd-webui-all-in-one](https://github.com/licyk/sd-webui-all-in-one) - 一个支持部署多种 WebUI 的 Jupyter Notebook / 支持一键部署 SD-Trainer，InvokeAI，ComfyUI，SD WebUI，SD-Trainer-Script 的 PowerShell 脚本
